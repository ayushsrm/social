    ...
    return(
        ...
        <Layout hideNavigation = {true}>
            ...
            <Card noPadding={true}>
                ...
                className="flex w-full gap-4 items-center justify-center p-4 border-b border-b-gray-100 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue transition-all hover:scale-110">
